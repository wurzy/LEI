...
const parser = (function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c397 = "having(",
        peg$c398 = peg$literalExpectation("having(", false),
        peg$c399 = function(prob, m) {
            return {
              name: m.name,
              value: {
                moustaches: "having",

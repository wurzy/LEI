...
const parser = (function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c146 = "random(",
        peg$c147 = peg$literalExpectation("random(", false),
        ...
        peg$c166 = "having(",
        peg$c167 = peg$literalExpectation("having(", false),
        peg$c168 = function(prob, m) {
            return {
              name: m.name,
              value: {
                moustaches: "having",
        ...
        peg$c169 = /^[0-9a-f]/i,
        peg$c170 = peg$classExpectation([["0", "9"], ["a", "f"]], false, true),

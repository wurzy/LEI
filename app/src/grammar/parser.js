...
const parser = (function() {
   ...
   function peg$parse(input, options) {
     ...
     var peg$FAILED = {},
         ...
         peg$c215 = function(min, max, unit) {
             return {
               moustaches: "integer",
               min, max, unit
             }
         ...
         peg$c216 = "floating(",
         peg$c217 = peg$literalExpectation("floating(", false),
         peg$c218 = function(min, max) {
             return {
               moustaches: "floating",
               min, max
             }
           },
         peg$c219 = function(min, max, decimals) {
             return {
               moustaches: "floating",
               min, max, decimals
             }
         ...
         peg$c224 = function(min, max, decimals, int_sep, dec_sep, unit) {
             return {
               moustaches: "floating",
         ...
         peg$c228 = "position(",
         peg$c229 = peg$literalExpectation("position(", false),
         peg$c230 = function(min_lat, max_lat, min_long, max_long) {
             return {
               moustaches: "position",
         ...
         peg$c233 = function() { return { moustaches: "phone" } },
         peg$c234 = "phone(",
         peg$c235 = peg$literalExpectation("phone(", false),
         peg$c236 = function(extension) {
             return {
               moustaches: "phone",
               extension
             }
         ...
         peg$c237 = "date(",
         peg$c238 = peg$literalExpectation("date(", false),
         peg$c239 = function(start, e) { return e },
         peg$c240 = function(start, end, f) { return f },
         peg$c241 = function(start, end, format) {
             return {
               moustaches: "date",
               start,
         ...
         peg$c248 = "distrito()",
         peg$c249 = peg$literalExpectation("distrito()", false),
         peg$c250 = "concelho()",
         peg$c251 = peg$literalExpectation("concelho()", false),
         peg$c252 = "freguesia()",
         peg$c253 = peg$literalExpectation("freguesia()", false),
         peg$c254 = function() {
             return { moustaches: text().slice(0, -2) }
           },
         peg$c255 = "concelho(",
         peg$c256 = peg$literalExpectation("concelho(", false),
         peg$c257 = /^[a-zA-Z\- ]/,
         peg$c258 = peg$classExpectation([["a", "z"], ["A", "Z"], "-", " "], false, false),
         peg$c259 = function(dist) {
             return {
               moustaches: "concelho",
               distrito: dist.trim()
             }
         ...
         peg$c260 = "freguesia(",
         peg$c261 = peg$literalExpectation("freguesia(", false),
         peg$c262 = /^[dD]/,
         peg$c263 = peg$classExpectation(["d", "D"], false, false),
         peg$c264 = /^[iI]/,
         peg$c265 = peg$classExpectation(["i", "I"], false, false),
         peg$c266 = /^[sS]/,
         peg$c267 = peg$classExpectation(["s", "S"], false, false),
         peg$c268 = /^[tT]/,
         peg$c269 = peg$classExpectation(["t", "T"], false, false),
         peg$c270 = /^[rR]/,
         peg$c271 = peg$classExpectation(["r", "R"], false, false),
         peg$c272 = /^[oO]/,
         peg$c273 = peg$classExpectation(["o", "O"], false, false),
         peg$c274 = /^[cC]/,
         peg$c275 = peg$classExpectation(["c", "C"], false, false),
         peg$c276 = /^[nN]/,
         peg$c277 = peg$classExpectation(["n", "N"], false, false),
         peg$c278 = /^[lL]/,
         peg$c279 = peg$classExpectation(["l", "L"], false, false),
         peg$c280 = /^[hH]/,
         peg$c281 = peg$classExpectation(["h", "H"], false, false),
         peg$c282 = function(keyword, name) {
             return {
         ...
         peg$c283 = function(head, r) { return r },
         peg$c284 = function(head, tail) { return ([head].concat(tail)).flat() },
         peg$c285 = function(values) { return values !== null ? values : [] },
         peg$c286 = function(size, val) {
             if (typeof val === 'object' && val !== null) return repeatArray(size,val)
             else return Array(size).fill(val)
           },
         peg$c287 = function(size, obj) {
             return repeatArray(size,obj)
           },
         peg$c288 = "repeat",
         peg$c289 = peg$literalExpectation("repeat", false),
         peg$c290 = "(",
         peg$c291 = peg$literalExpectation("(", false),
         peg$c292 = function(min, max) {
             return Math.floor(Math.random() * (max - min + 1)) + min
           },
         peg$c293 = function(min) {
             return min
           },
         peg$c294 = "range(",
         peg$c295 = peg$literalExpectation("range(", false),
         peg$c296 = function(num) {
             return [...Array(num).keys()]
           },
         peg$c297 = function(init, end) {
             var range = []
         ...
         peg$c298 = "missing(",
         peg$c299 = peg$literalExpectation("missing(", false),
         ...
         peg$c301 = "having(",
         peg$c302 = peg$literalExpectation("having(", false),
         peg$c303 = function(prob, m) {
             return {
               name: m.name,
               value: {
                 moustaches: "having",
         ...
         peg$c304 = /^[0-9a-f]/i,
         peg$c305 = peg$classExpectation([["0", "9"], ["a", "f"]], false, true),
                                                             ...
                                                             if (s20 !== peg$FAILED) {
                                                               ...
                                                               if (s21 !== peg$FAILED) {
                                                                 ...
                                                                 if (s22 !== peg$FAILED) {
                                                                   ...
                                                                   if (s23 !== peg$FAILED) {
                                                                     peg$savedPos = s0;
                                                                     s1 = peg$c224(s3, s7, s11, s16, s18, s20);
                                                                     s0 = s1;
                                                                   } else {
                                                                     peg$currPos = s0;
                                                                     s0 = peg$FAILED;

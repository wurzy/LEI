...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c112 = "00\"",
        peg$c113 = peg$literalExpectation("00\"", false),
        peg$c114 = function(min, max, dec, unit, int_sep, dec_sep) {
            var random = min + (max - min) * Math.random();
            var decimals = Math.floor(dec)
        ...
        peg$c118 = "lorem(",
        peg$c119 = peg$literalExpectation("lorem(", false),
        peg$c120 = function(num, units) {
            return loremIpsum({ count: Math.floor(num), units })
          },
        peg$c121 = "repeat",
        peg$c122 = peg$literalExpectation("repeat", false),
        peg$c123 = "(",
        peg$c124 = peg$literalExpectation("(", false),
        peg$c125 = function(min, max, val) {
            return Array(Math.floor(Math.random() * (Math.floor(max) - Math.floor(min) + 1)) + Math.floor(min)).fill(val)
         },
        peg$c126 = function(min, val) {
            return Array(Math.floor(min)).fill(val)
         },
        peg$c127 = "range(",
        peg$c128 = peg$literalExpectation("range(", false),
        peg$c129 = function(num) {
                                                        ...
                                                        if (s20 !== peg$FAILED) {
                                                          ...
                                                          if (s21 !== peg$FAILED) {
                                                            ...
                                                            if (s22 !== peg$FAILED) {
                                                              ...
                                                              if (s23 !== peg$FAILED) {
                                                                peg$savedPos = s0;
                                                                s1 = peg$c114(s3, s7, s11, s16, s18, s20);
                                                                s0 = s1;
                                                              } else {
                                                                peg$currPos = s0;
                                                                s0 = peg$FAILED;
